...
class WebSocketTester {
  ...
  open(url, options) {
    ...
    const ws = (this.ws = new WebSocket(url, options)) // eslint-disable-line no-multi-assign
    ...
    return new Promise((resolve) => { // eslint-disable-line consistent-return, prettier/prettier
      ws.on('open', () => {
        resolve(true)
      })
