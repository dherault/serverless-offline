...
export default class DockerContainer {
  ...
  constructor(
    ...
    this.#handler = image.command
    this.#imageNameTag = image.name
  ...
  async start() {
    log.info(`Running Docker container ${this.#imageNameTag}...`)
    ...
    const dockerArgs = [
      // '-v',
      // `${codeDir}:/var/task:${permissions},delegated`, # TODO: Handle specific folders being needed for build
      '-p',
      8080,
      '-e',
