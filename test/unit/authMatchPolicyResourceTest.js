...
describe('authMatchPolicyResource', () => {
  context('when resource has no wildcards', () => {
    ...
    context('and the resource matches', () => {
      it('returns true', () => {
        expect(authMatchPolicyResource(resource, resource)).to.eq(true);
      });
    });
    ...
    context('when the resource has one wildcard to match everything', () => {
      ...
      it('returns true', () => {
        expect(authMatchPolicyResource(wildcardResource, resource)).to.eq(true);
      });
    });
    ...
    context('when the resource has wildcards', () => {
      ...
      context('and it matches', () => {
        it('returns true', () => {
          expect(authMatchPolicyResource(wildcardResource, resource)).to.eq(
            true,
          );
        });
      });
